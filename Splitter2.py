...
for year in [1376, 1377, 1384, 1385, 1386, 1387, 1388, 1389, 1401, 1402]:
    loader = TextLoader("final2/{year}.tex".format(year=str(year)))
    docs = loader.load()
    ...
    for number, problem in enumerate(problems):
        ...
        all_problems["is_short_answer"].append(True)
